                    ...
                    <form id='form'>
                        <div class="twice-two">
                            <input type="text" class="form-control" name="nama" id="w3lName" placeholder="Nama Lengkap"
                                required="">
                            <input type="text" class="form-control" name="jk" id="w3lSender" placeholder="Jenis Kelamin"
                                required="">
                            <input type="text" class="form-control" name="tempat" id="w3lName" placeholder="Tempat"
                                required="">
                            <input type="text" class="form-control" name="tgllahir" id="w3lSender" placeholder="Tanggal Lahir"
                                required="">
